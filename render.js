...
function renderInfoBox(box, result) {
    ...
    createLineText([box[0]+10, box[1]+10, box[2]-ResultPercentWidth-0, ResultPercentHeight], (result[1]/10)+"% "+LANGUAGES[result[0]][curlang]).attr('fill', result[0]=="nota"?"white":"black")
    createText([box[0]+10, box[1]+20+ResultPercentHeight, box[2]-ResultPercentWidth-0, box[3]-30-ResultPercentHeight], result[0]+"desc",0,result[0]=="nota"?"white":"black")
}
