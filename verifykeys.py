...
vals = {"gov":"auth,olig,strato,dir,dir*,rep,rep*,cons,min","speech":"cont,cont*,moder,just,obs,free","legal":"retrib,retrib*,det,warn,rehab,decn","for":"iso,sov,pop,pop*,friend,friend*"}
for i in vals:
    vals[i] = vals[i].split(",")
    keysused.append(i)
    for i in vals[i]:
