...
vals = {"gov":"auth,olig,strato,dir,dir*,rep,cons,min","speech":"cont,moder,just,obs,free","legal":"retrib,det,warn,rehab,decn","for":"iso,auto,sov,pop,pop*,friend,friend*"}
for i in vals:
    vals[i] = vals[i].split(",")
    keysused.append(i)
    for i in vals[i]:
